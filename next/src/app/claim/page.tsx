...
export default function ClaimPage() {
    ...
    const { data: ascents, isLoading: isAscentsLoading } = useAscentsByGrantor(
        (grantors && Array.isArray(grantors) && grantors.length > 0) ? grantors[0] as `0x${string}` : '0x0000000000000000000000000000000000000000' as `0x${string}`
    );
    ...
    if (showClaimFlow) {
        return (
            <ClaimFlow 
                ...
                lastGrantorAddress={(grantors && Array.isArray(grantors) && grantors.length > 0) ? grantors[grantors.length-1] as string : ''}
            />
        );
    }
                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-base-content/60">
                            You do not have any claimable ascend at this time.
                        </p>
                    </div>
        ...
        <main className="min-h-screen flex flex-col items-center justify-center p-8">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-base-content/60">
                        You have an Ascend available for claiming
                    </p>
                </div>
